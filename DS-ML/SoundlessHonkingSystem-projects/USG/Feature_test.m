...
'Pick a file','C:\Users\subashnirmal\Documents\+ USG\Kaushal\Data\Modified normal');
...
if result == 0
    BL = BL*BL_factor;
    output = features(waves, sep, toler, BL);
    output(8) = result;
    output(9) = thr_percent;
    output(10) = BL_factor;
else
    BL = rows - BL;
    BL = BL*BL_factor;
    ...
    output = features(waves_inv, sep, toler, BL);
    output(8) = result;
    output(9) = thr_percent;
    output(10) = BL_factor;
end
