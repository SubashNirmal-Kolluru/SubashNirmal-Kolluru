...
% a1 = ahtSparse(a0,120,11,2,ceil(rows/3),ceil(2*rows/3));
...
a21 = zeros(rows,columns-2);
a2  = zeros(rows,columns-2);
a11 = zeros(rows,columns-2);
a31 = zeros(rows,columns-2);
